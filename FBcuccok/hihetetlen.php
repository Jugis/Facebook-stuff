            ...
            <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <center><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                    ...
                    <ins class="adsbygoogle"
                         ...
                         data-ad-client="ca-pub-9650008514121903"
                         data-ad-slot="9988139473"></ins>
                    <script>
                ...
                <div id="SC_TBlock_276742" class="SC_TBlock">loading...</div>
                ...
                <div class="post-content">
                    ...
                    for($i=0;$i<count($categories);$i++) {
                        $categories[$i]->cat_ID;
                        if($categories[$i]->cat_ID == 20){
                            $kategoria = $categories[$i]->cat_ID;
                        }
                    }
                    $write = '<link rel="stylesheet" type="text/css" href="http://hihetetlen.net/app.css">
<script>
$(document).ready(function() {
  $(".youtube").click(function() {
   logInWithFacebook();
                    ...
                    ?>
                    <div class="fb-like" data-href="<?php the_permalink(); ?>" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div><br>
                    <?php
                    ...
                    <div id="SC_TBlock_276756" class="SC_TBlock">loading...</div>
			...
			<a class="" href="javascript:void(0)" onclick="logInWithFacebook()">
				...
				<img class="img-responsive" src="http://hihetetlen.net/wp-content/uploads/2016/10/login.png" alt="Facebook login" />
		...
		<?php endif; ?>
                ...
                <?php if(isset($message_id) && $message_id == 1): ?>
                    ...
                    <h3 style="color: green; text-transform: uppercase; margin-bottom: 15px;">Sikeres bejelentkezés</h3>

                    <a class="" href="/fbshare.php?uid=<?php echo $uid; ?>&shareurl=<?php echo $slug; ?>">

                        <img class="img-responsive" src="http://hihetetlen.net/wp-content/uploads/2016/10/fb-share.png" alt="Facebook Share" />

                    </a>

                <?php elseif(isset($message_id) && $message_id == 2): ?>

                    <h3 style="color: green; text-transform: uppercase; margin-bottom: 15px;">Sikeres megosztás!</h3>

                <?php elseif(isset($message_id) && $message_id == 3): ?>

                    <h3 style="color: red; text-transform: uppercase; margin-bottom: 15px;">Hiba történt! Kérlek jelentkezz be újból az alkalmazásba és fogadd el az engedélyt!</h3>
                ...
                <?php endif; ?>
                <br><div class="fb-like" data-href="<?php the_permalink(); ?>" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
                <center><div class="fb-comments" data-href="<?php the_permalink(); ?>" data-width="720" data-numposts="5"></div></center>
                <div class="post-meta-container">
                    ...
                    <div class="post-meta">
                        ...
                        <div class="post-nav">
                            ...
                            if (!empty( $prev_post )): ?>
                                <a class="post-nav-prev" title="<?php _e('Előző Bejegyézs:', 'baskerville'); echo ' ' . esc_attr( get_the_title($prev_post) ); ?>" href="<?php echo get_permalink( $prev_post->ID ); ?>"><?php _e('Előző bejegyézs', 'baskerville'); ?></a>
                            ...
                            if (!empty( $next_post )): ?>
                                ...
                                <a class="post-nav-next" title="<?php _e('Következő bejegyzés:', 'baskerville'); echo ' ' . esc_attr( get_the_title($next_post) ); ?>" href="<?php echo get_permalink( $next_post->ID ); ?>"><?php _e('Következő bejegyzés', 'baskerville'); ?></a>
                ...
                <?php endwhile; else: ?>
                    ...
                    <p><?php _e("Nem találtam semmit ezel a kereső kifejezéssel, kérlek próbáld újból!", "baskerville"); ?></p>
